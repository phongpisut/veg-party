          ...
          <form onSubmit={submit} className="mt-6 space-y-5">
            <div>
              ...
              <input
                ...
                maxLength={20}
                className="mt-1 w-full rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-white placeholder:text-slate-500 focus:border-sky-400 focus:outline-none"
              />
            </div>

            <div>
              <label className="text-xs uppercase tracking-widest text-slate-400">Pick your emoji</label>
